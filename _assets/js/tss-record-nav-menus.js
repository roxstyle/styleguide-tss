// original record level responsive nav
(function( $, undefined ){
	$( function() {
	...
	// sections nav
		...
		$( "#cat-nav .sections-heading" ).collapsible();

		// Check to see if a subnav is actually present
		var thisContent = $( "#cat-nav nav.section" );

		//if ( thisContent.length && $( "li", thisContent ).length ) {
			var $headerb = $("#header-b #cat-nav");
			...
			$headerb.find( "h1 .collapsible-heading" )
